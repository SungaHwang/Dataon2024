...
# 경로 설정
train_dir = '/mnt/workspace/MyFiles/data/train_new/dog/o'
val_dir = '/mnt/workspace/MyFiles/data/test_new/dog/o'  # 검증 데이터 경로
batch_size = 128
num_epochs = 100 
...
checkpoint_path = os.path.join(checkpoint_dir, 'val3_dog_best_checkpoint.pth')
...
model_save_path = os.path.join(model_save_dir, 'classification_dog_convnextv2_base_model.pth')
